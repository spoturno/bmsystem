...
int main(){
    ...
    // (fist 32 bits of the factorial parts of the square roots of the first 8 primes 2..19):
    ...
    //(first 32 bits fo the fractional parts of the cube roots of the first 64 primes 2..311):
