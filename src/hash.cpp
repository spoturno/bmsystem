...
void sha256_transform(SHA256_CTX *ctx, const BYTE data[]){
    WORD a, b, c, d, e, f, g, h, i, j, t1, t2, m[64]; // i & j count var
...
void sha256_final(SHA256_CTX *ctx, BYTE hash[]){
   ...
   if(ctx->lenght < 56){
    ...
    ctx->bitlenght += ctx->lenght * 8;
    ctx->data[63] = ctx->bitlenght;
    ctx->data[62] = ctx->bitlenght >> 8;
    ctx->data[61] = ctx->bitlenght >> 16;
    ctx->data[60] = ctx->bitlenght >> 24;
    ctx->data[59] = ctx->bitlenght >> 32;
    ctx->data[58] = ctx->bitlenght >> 40;
    ctx->data[57] = ctx->bitlenght >> 48;
    ctx->data[56] = ctx->bitlenght >> 56;
    sha256_transform(ctx, ctx->data);
